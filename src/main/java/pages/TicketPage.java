...
public class TicketPage extends HelpdeskBasePage {
    ...
    private WebElement queue=driver.findElement(By.id("id_queue"));
    private WebElement email=driver.findElement(By.id("id_submitter_email"));
    private WebElement priority=driver.findElement(By.id("id_priority"));
    private WebElement description=driver.findElement(By.id("id_description"));
